...
<?php $this->load->view('layout/head') ?>
            ...
            <div class="x_panel" >
              <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox" style="padding:2%;">
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="glyphicon glyphicon-plus"></span> Sale</button>
                  </div>
                </ul>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <table id="datatable_sale" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr class="headings" >
                      ...
                      <th colspan="2" style="text-align:center;">Quantity Sale</th>
                      <th colspan="2" style="text-align:center;">Quantity Return</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><span class="glyphicon glyphicon-plus"></span> Add Sale Data </h4>
            </div>
            <div class="modal-body">
              <form id="form_sale" class="form-horizontal">
              <!-- <form id="form_sale" class="form-horizontal" action="<?php echo base_url();?>index.php/Sale_product/save_sale_data" method="post"> -->

                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Option<span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" name="insert_option" id="insert_option" required="required" >
                      <option >Select Option</option>
              ...
              <div class="col-sm-12>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" name="products_name" id="products_name" required="required" >
                      <option value="">Select Product Name</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" name="product_sizes" id="product_sizes" disabled required="required" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" name="style_names" id="style_names" required="required" >
                      <option value="">Select Style Name</option>
                    </select>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input   class="form-control col-md-7 col-xs-12" type="number" name="dozen" id="dozen" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input   class="form-control col-md-7 col-xs-12" type="number" min="1" max="11" id="piece" name="piece">
                </div>
              </div>

              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" class="btn btn-success" id="btn_save_sale">Submit</button>
  ...
  <?php $this->load->view('js/js_sale_product') ?>
